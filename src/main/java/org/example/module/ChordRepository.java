...
public class ChordRepository {
    ...
    static {
        ...
        chordsRepositoryList.add(new Chord(MelodicPosition.III, Spacing.CLOSE, Inversion.ROOT_POSITION, ChordType.TRIAD, Alteration.NONE, Occurrence.COMMON, new NoteOfScale(Degree.III, 5), new NoteOfScale(Degree.I, 5), new NoteOfScale(Degree.V, 4), new NoteOfScale(Degree.I, 3)));
        chordsRepositoryList.add(new Chord(MelodicPosition.V, Spacing.CLOSE, Inversion.ROOT_POSITION, ChordType.TRIAD, Alteration.NONE, Occurrence.COMMON, new NoteOfScale(Degree.V, 5), new NoteOfScale(Degree.III, 5), new NoteOfScale(Degree.I, 5), new NoteOfScale(Degree.I, 4)));
        ...
        chordsRepositoryList.add(new Chord(MelodicPosition.I, Spacing.OPEN, Inversion.ROOT_POSITION, ChordType.TRIAD, Alteration.NONE, Occurrence.COMMON, new NoteOfScale(Degree.I, 6), new NoteOfScale(Degree.III, 5), new NoteOfScale(Degree.V, 4), new NoteOfScale(Degree.I, 3)));
        chordsRepositoryList.add(new Chord(MelodicPosition.III, Spacing.OPEN, Inversion.ROOT_POSITION, ChordType.TRIAD, Alteration.NONE, Occurrence.COMMON, new NoteOfScale(Degree.III, 6), new NoteOfScale(Degree.V, 5), new NoteOfScale(Degree.I, 5), new NoteOfScale(Degree.I, 4)));
        ...
        chordsRepositoryList.add(new Chord(MelodicPosition.V, Spacing.OPEN, Inversion.ROOT_POSITION, ChordType.TRIAD, Alteration.NONE, Occurrence.COMMON, new NoteOfScale(Degree.V, 6), new NoteOfScale(Degree.I, 6), new NoteOfScale(Degree.III, 5), new NoteOfScale(Degree.I, 4)));
